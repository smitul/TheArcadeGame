...
var Engine = (function(global) {
    ...
    function startScreen() {
        ...
        ctx.fillStyle = "#fff";
        ctx.fillText("The Arcade GAME", 70, 90);
		...
		ctx.fillText("Press ANy key from 1 to 5", 100, 420);
		...
		ctx.fillText("- Smitul Soni (Front-End Developer)", 80, 580);
    ...
    function GameOver() {
		...
		ctx.font = "bold 20pt Arial";
        ctx.fillStyle = "#fff";
        ctx.fillText("The Arcade GAME", 70, 80);
        ...
        ctx.fillText("Refresh the page to play the game again" , 87, 420);
	...
	function GameWin() {
        ...
        ctx.fillStyle = "yellow";
        ctx.fillText("CONGRATULATIONS!",27, 210);
		ctx.font = "bold 22pt Arial";
        ctx.fillStyle = "#fff";
        ctx.fillText("YOU WON THE GAME",100,300);
        ctx.fillText("YOUR SCORE: " + score, 130, 380);
		ctx.font = "normal 12pt Arial";
        ctx.fillText("Refresh the page to play the game again." , 87, 450);
